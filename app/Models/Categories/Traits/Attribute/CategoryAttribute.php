...
trait CategoryAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        ...
        {
            return '<a class="btn btn-flat btn-default" href="'.route('admin.categories.edit', $this).'">
    ...
    public function getDeleteButtonAttribute()
    {
        ...
        {
            return '<a class="btn btn-flat btn-default" href="'.route('admin.categories.destroy', $this).'" data-method="delete"
